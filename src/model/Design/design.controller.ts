...
export const getDesignByIdController = async (req: Request <IDesignDetails> , res: Response) => {
    try {
...
export const updateDesignController = async (req: Request <IDesignDetails>, res: Response) => {
    try {
